(() => {
  const refs = {
    openModalBtn: document.querySelectorAll('[data-aboutmodal-open]'),
    closeModalBtn: document.querySelectorAll('[data-aboutmodal-close]'),
    modal: document.querySelectorAll('[data-aboutmodal]'),
    body: document.body,
  };
